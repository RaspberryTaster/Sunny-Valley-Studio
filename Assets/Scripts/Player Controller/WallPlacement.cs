...
public class WallPlacementState : IPlayerState
{
    public bool creating;
    public Tilemap wallGrid;
    public GameObject mouseIndicator;

    public WallPlacementState(Tilemap wallGrid, GameObject mouseIndicator)
    {
        creating = false;
    ...
    {
        Debug.LogWarning("Enterd: Wall State");
        // Perform any setup or actions when entering this state for Wall Placement.
    }
